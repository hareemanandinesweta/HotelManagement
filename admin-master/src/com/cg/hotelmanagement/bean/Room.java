...
public class Room {
    ...
    public Room(long roomid, String roomtype, String roomCheckIn, String roomCheckOut, String roomcost) {
        this.roomid = roomid;
    ...
    public Room(long roomid, String roomtype, String roomCheckIn, String roomCheckOut, String roomcost, List<Booking> bookingDetails) {
        this.roomid = roomid;
        this.roomtype = roomtype;
        this.roomCheckIn = roomCheckIn;
        this.roomCheckOut = roomCheckOut;
